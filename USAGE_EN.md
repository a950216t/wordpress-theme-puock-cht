...
3. In the right sidebar under `Page Attributes` → `Template`, select **Friendship Links (`友情連結`)** template
...
3. Select Puock Alert (Puock 提示框) block
...
2. Is the page template set to Friendship Links (友情連結)?
