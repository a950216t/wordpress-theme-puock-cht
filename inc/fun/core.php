...
function pk_get_main_menu($mobile = false)
{
    ...
    if (is_user_logged_in()) {
        ...
        $out .= '<li><a ' . (pk_is_user_center_theme() ? '' : 'data-no-instant') . ' data-bs-toggle="tooltip" title="' . esc_attr__('使用者中心', PUOCK) . '" href="' . pk_user_center_url() . '"><img alt="' . esc_attr__('使用者中心', PUOCK) . '" src="' . $avatar . '" class="min-avatar"></a></li>';
    } else {
